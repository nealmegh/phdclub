...
class ProfileController extends Controller
{
    ...
    public function update(UpdateProfileRequest $request)
    {
        $output = $this->userRepository->update(
            $request->user()->id,
            $request->only('first_name', 'last_name', 'email', 'avatar_type', 'avatar_location', 'timezone', 'category_id', 'country', 'address', 'work', 'designation', 'birthday', 'gender', 'topic', 'institution', 'supervisor', 'country_phd', 'city', 'state', 'zip'),
