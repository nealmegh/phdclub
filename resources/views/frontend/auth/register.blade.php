                ...
                <div class="card-body">
                   ...
                   {{--Form Section Part 1 Start--}}
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                {{ html()->label(__('validation.attributes.frontend.birthday'))->for('birthday') }}

                                {{ html()->date('birthday')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.frontend.birthday'))
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {{ html()->select('gender', ['male'=>'Male', 'female'=>'Female', 'none'=>'Not Specified'])
                                    ->class('form-control')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                {{ html()->label(__('validation.attributes.frontend.topic'))->for('topic') }}

                                {{ html()->text('topic')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.frontend.topic'))
                                    ->attribute('maxlength', 200)
                                    ->required() }}
                            </div><!--form-group-->
                        </div><!--col-->
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                {{ html()->label(__('validation.attributes.frontend.institution'))->for('institution') }}

                                {{ html()->text('institution')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.frontend.institution'))
                                    ->attribute('maxlength', 200)
                                    ->required() }}
                            </div><!--form-group-->
                        </div><!--col-->
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                {{ html()->label(__('validation.attributes.frontend.supervisor'))->for('supervisor') }}

                                {{ html()->text('supervisor')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.frontend.supervisor'))
                                    ->attribute('maxlength', 200)
                                    ->required() }}
                            </div><!--form-group-->
                        </div><!--col-->
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                {{ html()->label(__('validation.attributes.frontend.country'))->for('country_phd') }}

                                {{ html()->select('country_phd', $countries)
                                    ->class('form-control')
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    {{ html()->label(__('validation.attributes.frontend.postcode'))->for('postcode') }}

                                    {{ html()->text('postcode')
                                        ->class('form-control')
                                        ->placeholder(__('validation.attributes.frontend.postcode'))
                                        ->attribute('maxlength', 200)
                                        ->required() }}
                                </div><!--form-group-->
                            </div><!--col-->
                    ...
                    <div class="form-navigation">
                        <button type="button" class="previous btn btn-sm btn-success pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i> Previous</button>
                        <button type="button" class="next btn btn-sm btn-success pull-right">Next <i class="fa fa-angle-right" aria-hidden="true"></i></button>
